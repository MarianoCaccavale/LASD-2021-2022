...
namespace lasd
{
    ...
    Data BST<Data>::SuccessorNRemove(const Data &dato)
    {
        ...
        Data dataToReturn = (*pointerToSuccessor)->data;
    ...
    template <typename Data>
    bool BST<Data>::Insert(const Data &datoToInsert)
    {
    ...
    template <typename Data>
    bool BST<Data>::Insert(Data &&datoToInsert)
    {
        NodeLnk *&pointerWhereAdd = FindPointerTo(this->root, datoToInsert);
    ...
    template <typename Data>
    bool BST<Data>::Remove(const Data &datoToRemove)
    {
    ...
    typename BST<Data>::NodeLnk *BST<Data>::Detach(typename BST<Data>::NodeLnk *&nodeToDetach) noexcept
    {
        ...
        {
            // Applico """""StaccaMax"""""
            NodeLnk *max = DetachMax(nodeToDetach->leftChild);
