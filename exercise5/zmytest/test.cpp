...
void menu()
{
    ...
    while (true)
    {
        ...
        case 1:
            ...
            std::cout << "Scelta della struttura dati da testare( (V)ector, (L)ist , (C)oda, (P)ila, Binary(T)ree, (B)st, (H)ashTable)" << std::endl;
            ...
            else if (scelta_struttura == 'H')
            {

                // Mariano.py

                std::cout << "Di che tipo vuoi che sia la struttura HashTable? ( (I)nt, (D)ouble, (S)tring )" << std::endl;
                std::cin >> scelta_tipo;
                ...
                case 'I':
                    ...
                    std::cout << "Di che dimensione vuoi la struttura?" << std::endl;
                    std::cin >> scelta_dim;
                    HashTableMenu<int>(scelta_dim, scelta_tipo);
                ...
                case 'D':
                    ...
                    std::cout << "Di che dimensione vuoi la struttura?" << std::endl;
                    std::cin >> scelta_dim;
                    HashTableMenu<double>(scelta_dim, scelta_tipo);
                ...
                case 'S':
                    ...
                    std::cout << "Di che dimensione vuoi la struttura?" << std::endl;
                    std::cin >> scelta_dim;
                    HashTableMenu<std::string>(scelta_dim, scelta_tipo);
...
void foldProd(const int &dato, const void *parametro, void *accumulatore)
{
...
void foldTest(lasd::FoldableContainer<int> &struttura)
{

    unsigned int n, ris = 1;

    std::cout << "Prodotto dei numeri interi minori di n, che vale?" << std::endl;
    std::cin >> n;

    struttura.Fold(&foldProd, &n, &ris);
    std::cout << "Il risultato è:" << ris << std::endl;
}

void foldSum(const double &dato, const void *parametro, void *accumulatore)
{
...
void foldTest(lasd::FoldableContainer<double> &struttura)
{
...
void foldTest(lasd::FoldableContainer<std::string> &struttura)
{
    ...
    struttura.Fold(&foldConcat, &n, &stringa_finale);
...
void intRandGenVect(lasd::Vector<Data> &struttura)
{
    ...
    std::uniform_int_distribution<int> distributore(1, 100);
...
void floatRandGenVect(lasd::Vector<Data> &struttura)
{
    ...
    std::default_random_engine gen(std::random_device{}());
    std::uniform_real_distribution<float> distributore(1.0, 100.0);

    for (unsigned long index = 0; index < struttura.Size(); index++)
    {

        struttura[index] = distributore(gen);
        std::cout << std::setprecision(20) << struttura[index] << std::endl;
    }
...
template <typename Data>
void HashTableMenu(ulong dimensione, char tipo)
{

    char tipo_impl;

    std::cout << "Come vuoi implementare la struttura? ((C)losed Hashing o (O)pen Hashing)" << std::endl;
    std::cin >> tipo_impl;
    ...
    case 'C':
        ...
        case 'I':
        {
            ...
            lasd::Vector<int> vett_temp = lasd::Vector<int>(dimensione);
            intRandGenVect<int>(vett_temp);
            lasd::HashTableClsAdr<int> ht = lasd::HashTableClsAdr<int>(vett_temp);
            HashTableTestMenu<int>(ht);
        ...
        case 'D':
        {
            ...
            lasd::Vector<double> vett_temp = lasd::Vector<double>(dimensione);
            floatRandGenVect<double>(vett_temp);
            lasd::HashTableClsAdr<double> ht = lasd::HashTableClsAdr<double>(vett_temp);
            HashTableTestMenu<double>(ht);
        ...
        case 'S':
        {
            ...
            lasd::Vector<std::string> vett_temp = lasd::Vector<std::string>(dimensione);
            stringRandGenVect<std::string>(vett_temp);
            lasd::HashTableClsAdr<std::string> ht = lasd::HashTableClsAdr<std::string>(vett_temp);
            HashTableTestMenu<std::string>(ht);
    ...
    case 'O':
        ...
        case 'I':
        {
            ...
            lasd::Vector<int> vett_temp = lasd::Vector<int>(dimensione);
            intRandGenVect<int>(vett_temp);
            lasd::HashTableOpnAdr<int> ht = lasd::HashTableOpnAdr<int>(vett_temp);
            HashTableTestMenu<int>(ht);
        ...
        case 'D':
        {
            ...
            lasd::Vector<double> vett_temp = lasd::Vector<double>(dimensione);
            floatRandGenVect<double>(vett_temp);
            lasd::HashTableOpnAdr<double> ht = lasd::HashTableOpnAdr<double>(vett_temp);
            HashTableTestMenu<double>(ht);
        ...
        case 'S':
        {
            ...
            lasd::Vector<std::string> vett_temp = lasd::Vector<std::string>(dimensione);
            stringRandGenVect<std::string>(vett_temp);
            lasd::HashTableOpnAdr<std::string> ht = lasd::HashTableOpnAdr<std::string>(vett_temp);
            HashTableTestMenu<std::string>(ht);
...
template <typename Data>
void HashTableTestMenu(lasd::HashTable<Data> &ht)
{
    ...
    while (true)
    {
        ...
        std::cout << "Scelta dell'operazione" << std::endl;
        std::cout << "1) Visualizzazione della struttura:" << std::endl;
        std::cout << "2) Controllo di esistenza:" << std::endl;
        std::cout << "3) Applicazione di una funzione in base al tipo di elementi:" << std::endl;
        std::cout << "4) Uscita" << std::endl;
        ...
        case 1:
        {
            ht.Map([](Data &dato, void *parametro)
                   { std::cout << std::setprecision(20) << dato << std::endl; },
                   0);
