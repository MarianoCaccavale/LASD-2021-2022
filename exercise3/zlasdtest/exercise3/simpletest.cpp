...
void stestBinaryTreeInt(uint &testnum, uint &testerr)
{
  uint loctestnum = 0, loctesterr = 0;
  cout << endl
       << "Begin of BinaryTree<int> Test" << endl;
  try
  {
...
void stestBinaryTreeFloat(uint &testnum, uint &testerr)
{
  uint loctestnum = 0, loctesterr = 0;
  cout << endl
       << "Begin of BinaryTree<double> Test" << endl;
  try
  {
...
void stestBinaryTreeString(uint &testnum, uint &testerr)
{
  uint loctestnum = 0, loctesterr = 0;
  cout << endl
       << "Begin of BinaryTree<string> Test" << endl;
  try
  {
    ...
    cout << endl
         << "Begin of BinaryTreeVec<string> Test:" << endl;
...
void testSimpleExercise3()
{
  ...
  cout << endl
       << "Exercise 3 (Simple Test) (Errors/Tests: " << testerr << "/" << testnum << ")" << endl;
}
